...
// Notice: SiteHeader and SiteFooter are removed here so they don't duplicate on the home page!
export default function Gallery() {
  ...
  return (
    /* We converted this wrapper from a page shell div into a <section> with id="gallery" */
    <section id="gallery" className="py-24 px-4 sm:px-8 bg-[#0d1009] text-white font-mono relative overflow-x-hidden z-10 border-t border-[#a4c875]/10">
